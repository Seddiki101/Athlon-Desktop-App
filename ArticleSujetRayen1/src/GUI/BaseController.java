...
public class BaseController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("/GUI/GestionSujet.fxml"));
            removeSelectedStyle();
    ...
    private void LoadGestionArticle(MouseEvent event) {
        Parent root;
        try {
            root = FXMLLoader.load(getClass().getResource("/GUI/GestionArticle.fxml"));
            removeSelectedStyle();
    ...
    public void LoadGestionComment(MouseEvent event) {
        try {
            Parent root;
            root = FXMLLoader.load(getClass().getResource("/GUI/GestionComment.fxml"));
            removeSelectedStyle();
